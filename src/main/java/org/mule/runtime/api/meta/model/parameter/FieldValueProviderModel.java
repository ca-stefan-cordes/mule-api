...
/**
 * Model for {@link ParameterModel} to communicate if one of these are capable to provide {@link Value values} for its
 * fields.
 *
 * @since 1.4
 */
public class FieldValueProviderModel extends ValueProviderModel {
   ...
   * @param fieldPath             the path of the field whose values are provided within the parameter
   * @since 1.4.0
   */
  public FieldValueProviderModel(List<ActingParameterModel> parameters, boolean requiresConfiguration, boolean requiresConnection,
                                 boolean isOpen, Integer partOrder, String providerName, String providerId, String fieldPath) {
  ...
  public boolean equals(Object o) {
    ...
    return new EqualsBuilder()
        .append(fieldPath, that.fieldPath)
        .isEquals() && super.equals(o);
  }

  @Override
  public int hashCode() {
    return hash(super.hashCode(), fieldPath);
  }
}
